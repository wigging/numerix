...
Numerix is a Swift package that uses the Accelerate framework to perform high-performance and energy-efficient vector and matrix calculations on macOS and iOS. See the sections below to learn more about the package.
...
Numerical types for working with complex numbers, vectors, and matrices.
