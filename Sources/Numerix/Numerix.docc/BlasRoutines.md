...
Numerix uses the Accelerate framework to access Basic Linear Algebra Subprograms (BLAS) for performing common linear algebra operations. The tables below list BLAS routines along with the related Numerix functions and methods for each level of functionality. 

## Level 1

This BLAS level contains vector operations; however, in Numerix, some of these functions are also available for matrix and shaped arrays.
