/*
Vector logarithm protocol and associated extensions.
*/

import Accelerate

@_documentation(visibility: private)
public protocol VectorLogarithm {
...
@_documentation(visibility: private)
extension Double: VectorLogarithm {
...
@_documentation(visibility: private)
extension Float: VectorLogarithm {
...
extension Vector where Scalar: VectorLogarithm {
